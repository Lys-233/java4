...
public class Text {
	...
	public static String readFile() {
		...
		File file = new File("C:\\Users\\Admin\\Desktop\\1.txt"); //这里的地址可以根据实际情况修改
		try {
	...
	public static void writeFile(String newStr,String stuStr,String countStr)throws IOException
	{
		...
		FileOutputStream fos=new FileOutputStream("C:\\Users\\Admin\\Desktop\\2.txt"); //这里的地址可以根据实际情况修改
